...
This guide covers development setup, project structure, and how to extend the TRUMPF Oseon MCP Server.
...
- Git
- Access to a TRUMPF Oseon system for testing
...
cp env.example .env
# Edit .env with your development Oseon instance
...
uv run mcp install trumpf_oseon_mcp.py --name "TRUMPF Oseon Dev"
...
│       ├── __main__.py           # Main MCP server entry point (2000+ lines)
│       └── config.py             # Configuration management
├── docs/                         # Documentation
│   ├── advanced-usage.md         # Advanced features and bulk operations
│   └── development.md            # This file
├── examples/                     # Example configurations
│   ├── claude_desktop_config.json.template
│   └── README.md
├── resources/                    # API specifications
│   └── Swagger-API-Oseon-v2.json
├── tests/                        # Test suite
│   ├── __init__.py
│   └── test_mcp_server.py
├── tools/                        # Development tools and scripts
├── trumpf_oseon_mcp.py          # Entry point script
...
DEBUG=1 uv run mcp dev trumpf_oseon_mcp.py
